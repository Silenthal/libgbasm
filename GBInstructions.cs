...
namespace LibGBasm
{
	internal class GBInstructions
	{
		...
		internal static GBInstructionUnit[] InstructionUnitTable = new GBInstructionUnit[256]
		{
			...
			//B0-BF
			new GBInstructionUnit() { InstSize = 1, ArgCount = 1, InstType = InstructionType.or, Arg1 = RegB },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 1, InstType = InstructionType.or, Arg1 = RegC },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 1, InstType = InstructionType.or, Arg1 = RegD },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 1, InstType = InstructionType.or, Arg1 = RegE },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 1, InstType = InstructionType.or, Arg1 = RegH },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 1, InstType = InstructionType.or, Arg1 = RegL },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 1, InstType = InstructionType.or, Arg1 = HLMap },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 1, InstType = InstructionType.or, Arg1 = RegA },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 1, InstType = InstructionType.cp, Arg1 = RegB },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 1, InstType = InstructionType.cp, Arg1 = RegC },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 1, InstType = InstructionType.cp, Arg1 = RegD },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 1, InstType = InstructionType.cp, Arg1 = RegE },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 1, InstType = InstructionType.cp, Arg1 = RegH },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 1, InstType = InstructionType.cp, Arg1 = RegL },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 1, InstType = InstructionType.cp, Arg1 = HLMap },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 1, InstType = InstructionType.cp, Arg1 = RegA },
			//C0-CF
