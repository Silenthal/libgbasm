namespace LibGBasm
{
	internal class GBInstructions
	{
		...
		private static GBArgument ByteArg0 = new GBArgument() { ArgType = GBArgumentType.Byte, NumberArg = 0 };
		private static GBArgument ByteArg1 = new GBArgument() { ArgType = GBArgumentType.Byte, NumberArg = 1 };
		private static GBArgument ByteArg2 = new GBArgument() { ArgType = GBArgumentType.Byte, NumberArg = 2 };
		private static GBArgument ByteArg3 = new GBArgument() { ArgType = GBArgumentType.Byte, NumberArg = 3 };
		private static GBArgument ByteArg4 = new GBArgument() { ArgType = GBArgumentType.Byte, NumberArg = 4 };
		private static GBArgument ByteArg5 = new GBArgument() { ArgType = GBArgumentType.Byte, NumberArg = 5 };
		private static GBArgument ByteArg6 = new GBArgument() { ArgType = GBArgumentType.Byte, NumberArg = 6 };
		private static GBArgument ByteArg7 = new GBArgument() { ArgType = GBArgumentType.Byte, NumberArg = 7 };
		...
		internal static GBInstructionUnit[] InstructionUnitTable = new GBInstructionUnit[256]
		{
			...
			new GBInstructionUnit() { InstSize = 2, ArgCount = 1, InstType = InstructionType.jr, Arg1 = WordArg },
			...
			new GBInstructionUnit() { InstSize = 2, ArgCount = 2, InstType = InstructionType.jr, Arg1 = NZCond, Arg2 = WordArg },
			...
			new GBInstructionUnit() { InstSize = 2, ArgCount = 2, InstType = InstructionType.jr, Arg1 = ZCond, Arg2 = WordArg },
			...
			new GBInstructionUnit() { InstSize = 2, ArgCount = 2, InstType = InstructionType.jr, Arg1 = NCCond, Arg2 = WordArg },
			...
			new GBInstructionUnit() { InstSize = 2, ArgCount = 2, InstType = InstructionType.jr, Arg1 = CCond, Arg2 = WordArg },
			...
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.and, Arg1 = RegA, Arg2 = RegB },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.and, Arg1 = RegA, Arg2 = RegC },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.and, Arg1 = RegA, Arg2 = RegD },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.and, Arg1 = RegA, Arg2 = RegE },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.and, Arg1 = RegA, Arg2 = RegH },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.and, Arg1 = RegA, Arg2 = RegL },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.and, Arg1 = RegA, Arg2 = HLMap },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.and, Arg1 = RegA, Arg2 = RegA },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.xor, Arg1 = RegA, Arg2 = RegB },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.xor, Arg1 = RegA, Arg2 = RegC },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.xor, Arg1 = RegA, Arg2 = RegD },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.xor, Arg1 = RegA, Arg2 = RegE },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.xor, Arg1 = RegA, Arg2 = RegH },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.xor, Arg1 = RegA, Arg2 = RegL },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.xor, Arg1 = RegA, Arg2 = HLMap },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.xor, Arg1 = RegA, Arg2 = RegA },

			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.or, Arg1 = RegA, Arg2 = RegB },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.or, Arg1 = RegA, Arg2 = RegC },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.or, Arg1 = RegA, Arg2 = RegD },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.or, Arg1 = RegA, Arg2 = RegE },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.or, Arg1 = RegA, Arg2 = RegH },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.or, Arg1 = RegA, Arg2 = RegL },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.or, Arg1 = RegA, Arg2 = HLMap },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.or, Arg1 = RegA, Arg2 = RegA },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.cp, Arg1 = RegA, Arg2 = RegB },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.cp, Arg1 = RegA, Arg2 = RegC },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.cp, Arg1 = RegA, Arg2 = RegD },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.cp, Arg1 = RegA, Arg2 = RegE },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.cp, Arg1 = RegA, Arg2 = RegH },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.cp, Arg1 = RegA, Arg2 = RegL },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.cp, Arg1 = RegA, Arg2 = HLMap },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 2, InstType = InstructionType.cp, Arg1 = RegA, Arg2 = RegA },
			...
			new GBInstructionUnit() { InstSize = 1, ArgCount = 0, InstType = InstructionType.invalid },
			...
			new GBInstructionUnit() { InstSize = 2, ArgCount = 2, InstType = InstructionType.and, Arg1 = RegA, Arg2 = ByteArg },
			...
			new GBInstructionUnit() { InstSize = 1, ArgCount = 0, InstType = InstructionType.invalid },
			new GBInstructionUnit() { InstSize = 1, ArgCount = 0, InstType = InstructionType.invalid },
			new GBInstructionUnit() { InstSize = 2, ArgCount = 1, InstType = InstructionType.cp, Arg1 = RegA },
		...
		internal static GBInstructionUnit[] CBInstructionUnitTable = new GBInstructionUnit[256]
		{
			...
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg0, Arg2 = RegB },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg0, Arg2 = RegC },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg0, Arg2 = RegD },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg0, Arg2 = RegE },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg0, Arg2 = RegH },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg0, Arg2 = RegL },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg0, Arg2 = HLMap },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg0, Arg2 = RegA },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg1, Arg2 = RegB },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg1, Arg2 = RegC },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg1, Arg2 = RegD },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg1, Arg2 = RegE },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg1, Arg2 = RegH },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg1, Arg2 = RegL },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg1, Arg2 = HLMap },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg1, Arg2 = RegA },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg2, Arg2 = RegB },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg2, Arg2 = RegC },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg2, Arg2 = RegD },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg2, Arg2 = RegE },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg2, Arg2 = RegH },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg2, Arg2 = RegL },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg2, Arg2 = HLMap },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg2, Arg2 = RegA },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg3, Arg2 = RegB },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg3, Arg2 = RegC },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg3, Arg2 = RegD },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg3, Arg2 = RegE },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg3, Arg2 = RegH },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg3, Arg2 = RegL },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg3, Arg2 = HLMap },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg3, Arg2 = RegA },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg4, Arg2 = RegB },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg4, Arg2 = RegC },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg4, Arg2 = RegD },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg4, Arg2 = RegE },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg4, Arg2 = RegH },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg4, Arg2 = RegL },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg4, Arg2 = HLMap },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg4, Arg2 = RegA },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg5, Arg2 = RegB },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg5, Arg2 = RegC },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg5, Arg2 = RegD },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg5, Arg2 = RegE },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg5, Arg2 = RegH },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg5, Arg2 = RegL },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg5, Arg2 = HLMap },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg5, Arg2 = RegA },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg6, Arg2 = RegB },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg6, Arg2 = RegC },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg6, Arg2 = RegD },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg6, Arg2 = RegE },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg6, Arg2 = RegH },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg6, Arg2 = RegL },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg6, Arg2 = HLMap },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg6, Arg2 = RegA },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg7, Arg2 = RegB },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg7, Arg2 = RegC },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg7, Arg2 = RegD },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg7, Arg2 = RegE },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg7, Arg2 = RegH },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg7, Arg2 = RegL },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg7, Arg2 = HLMap },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.bit, ArgCount = 2, Arg1 = ByteArg7, Arg2 = RegA },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg0, Arg2 = RegB },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg0, Arg2 = RegC },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg0, Arg2 = RegD },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg0, Arg2 = RegE },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg0, Arg2 = RegH },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg0, Arg2 = RegL },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg0, Arg2 = HLMap },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg0, Arg2 = RegA },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg1, Arg2 = RegB },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg1, Arg2 = RegC },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg1, Arg2 = RegD },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg1, Arg2 = RegE },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg1, Arg2 = RegH },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg1, Arg2 = RegL },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg1, Arg2 = HLMap },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg1, Arg2 = RegA },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg2, Arg2 = RegB },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg2, Arg2 = RegC },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg2, Arg2 = RegD },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg2, Arg2 = RegE },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg2, Arg2 = RegH },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg2, Arg2 = RegL },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg2, Arg2 = HLMap },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg2, Arg2 = RegA },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg3, Arg2 = RegB },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg3, Arg2 = RegC },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg3, Arg2 = RegD },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg3, Arg2 = RegE },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg3, Arg2 = RegH },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg3, Arg2 = RegL },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg3, Arg2 = HLMap },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg3, Arg2 = RegA },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg4, Arg2 = RegB },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg4, Arg2 = RegC },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg4, Arg2 = RegD },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg4, Arg2 = RegE },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg4, Arg2 = RegH },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg4, Arg2 = RegL },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg4, Arg2 = HLMap },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg4, Arg2 = RegA },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg5, Arg2 = RegB },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg5, Arg2 = RegC },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg5, Arg2 = RegD },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg5, Arg2 = RegE },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg5, Arg2 = RegH },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg5, Arg2 = RegL },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg5, Arg2 = HLMap },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg5, Arg2 = RegA },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg6, Arg2 = RegB },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg6, Arg2 = RegC },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg6, Arg2 = RegD },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg6, Arg2 = RegE },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg6, Arg2 = RegH },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg6, Arg2 = RegL },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg6, Arg2 = HLMap },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg6, Arg2 = RegA },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg7, Arg2 = RegB },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg7, Arg2 = RegC },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg7, Arg2 = RegD },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg7, Arg2 = RegE },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg7, Arg2 = RegH },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg7, Arg2 = RegL },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg7, Arg2 = HLMap },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.res, ArgCount = 2, Arg1 = ByteArg7, Arg2 = RegA },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg0, Arg2 = RegB },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg0, Arg2 = RegC },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg0, Arg2 = RegD },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg0, Arg2 = RegE },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg0, Arg2 = RegH },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg0, Arg2 = RegL },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg0, Arg2 = HLMap },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg0, Arg2 = RegA },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg1, Arg2 = RegB },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg1, Arg2 = RegC },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg1, Arg2 = RegD },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg1, Arg2 = RegE },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg1, Arg2 = RegH },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg1, Arg2 = RegL },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg1, Arg2 = HLMap },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg1, Arg2 = RegA },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg2, Arg2 = RegB },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg2, Arg2 = RegC },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg2, Arg2 = RegD },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg2, Arg2 = RegE },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg2, Arg2 = RegH },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg2, Arg2 = RegL },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg2, Arg2 = HLMap },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg2, Arg2 = RegA },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg3, Arg2 = RegB },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg3, Arg2 = RegC },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg3, Arg2 = RegD },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg3, Arg2 = RegE },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg3, Arg2 = RegH },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg3, Arg2 = RegL },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg3, Arg2 = HLMap },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg3, Arg2 = RegA },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg4, Arg2 = RegB },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg4, Arg2 = RegC },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg4, Arg2 = RegD },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg4, Arg2 = RegE },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg4, Arg2 = RegH },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg4, Arg2 = RegL },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg4, Arg2 = HLMap },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg4, Arg2 = RegA },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg5, Arg2 = RegB },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg5, Arg2 = RegC },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg5, Arg2 = RegD },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg5, Arg2 = RegE },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg5, Arg2 = RegH },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg5, Arg2 = RegL },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg5, Arg2 = HLMap },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg5, Arg2 = RegA },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg6, Arg2 = RegB },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg6, Arg2 = RegC },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg6, Arg2 = RegD },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg6, Arg2 = RegE },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg6, Arg2 = RegH },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg6, Arg2 = RegL },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg6, Arg2 = HLMap },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg6, Arg2 = RegA },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg7, Arg2 = RegB },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg7, Arg2 = RegC },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg7, Arg2 = RegD },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg7, Arg2 = RegE },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg7, Arg2 = RegH },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg7, Arg2 = RegL },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg7, Arg2 = HLMap },
			new GBInstructionUnit() { InstSize = 2, InstType = InstructionType.set, ArgCount = 2, Arg1 = ByteArg7, Arg2 = RegA },
		};
